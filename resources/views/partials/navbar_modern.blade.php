                    ...
                    @if (auth()->user()->role === 'admin')
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow-sm">
                                <li><a class="dropdown-item" href="{{ route('admin.fields.index') }}"><i
                                            class="bi bi-building me-2"></i>Kelola Lapangan</a></li>
                                <li><a class="dropdown-item" href="{{ route('admin.bookings.index') }}"><i
                                            class="bi bi-clipboard-check me-2"></i>Kelola Booking</a></li>
                            </ul>
                        </li>
                    @endif
                @endauth
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                @else
                    <li class="nav-item me-lg-2">
                        <a class="btn naisya-btn naisya-btn-soft btn-sm rounded-pill px-3" href="{{ route('dashboard') }}">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" role="button"
                            ...
                            <span class="naisya-avatar">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</span>
                            <span class="d-none d-lg-inline">{{ auth()->user()->name }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                            <li class="dropdown-item-text small text-muted">
                                Role: <span class="text-capitalize fw-semibold">{{ auth()->user()->role }}</span>
                            </li>
                            <li>
